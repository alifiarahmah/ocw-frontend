        ...
        <Container className={styles.container}>
          <a className={styles.h1}>
            <Text fontSize="4xl" className={merriweather.className}>
              <strong>
                {' '}
                <span className={styles.boldtext}> Selamat Datang!</span>{' '}
              </strong>{' '}
            </Text>
          </a>
          <a className={styles.h2}>
            <Text className={poppins.className}>
              <strong>
                {' '}
                Kami tidak sabar untuk menemani Anda belajar. Sebelum mulai,
                Anda harus melakukan verifikasi email terlebih dahulu dengan{' '}
