      ...
      <Container minHeight="90vh" bgColor="biru.500" width="50vh" padding={10}>
        <VStack align={'start'} spacing='6' marginStart='2vh' maxWidth="30vh">
          <VStack spacing='1' align={'start'}>
              ...
              <Text align={'start'} fontSize={'xl'} wordBreak="break-word">{course_code}</Text>
          </VStack>
          <Divider borderColor={'black'} borderWidth={"1px"} w='75%' my={4}/>
          <VStack spacing='1' align={'start'}>
              <Text align={'start'} fontSize={'m'}>Mata Kuliah</Text>
              <Text align={'start'} fontSize={'xl'} wordBreak="break-word">{course_name}</Text>
          </VStack>
          <Divider borderColor={'black'} borderWidth={"1px"} w='75%' my={4}/>
          <VStack spacing='1' align={'start'}>
              <Text align={'start'} fontSize={'m'}>Dosen Pengajar</Text>
              <Text align={'start'} fontSize={'xl'} wordBreak="break-word">{lecturer}</Text>
          </VStack>
        </VStack>
      </Container>
    </HStack>
